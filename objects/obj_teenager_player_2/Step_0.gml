...
if (delta_x == 1 and delta_y == 1) {
	sprite_index = spr_teenager_down;
} else if (delta_x == -1 and delta_y == -1) {
	sprite_index = spr_teenager_up;
} else if (delta_x == (0.5 / cos(degtorad(30))) and delta_y == -(0.5 / cos(degtorad(30)))) {
	sprite_index = spr_teenager_right;
} else if (delta_x == -(0.5 / cos(degtorad(30))) and delta_y == (0.5 / cos(degtorad(30)))) {
	sprite_index = spr_teenager_left;
} else if (delta_x == 1 and delta_y == 0) {
	sprite_index = spr_teenager_downright;
} else if (delta_x == 0 and delta_y == 1) {
	sprite_index = spr_teenager_downleft;
} else if (delta_x == 0 and delta_y == -1) {
	sprite_index = spr_teenager_upright;
} else if (delta_x == -1 and delta_y == 0) {
	sprite_index = spr_teenager_upleft;
} else {
	sprite_index = spr_teenager_idle;
